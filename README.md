...
- Phase 1 data layer: `event code → instructional areas + PI pool` for
  Principles of Marketing (PMK). **PI text is placeholder** until the official
  wording is filled in.
